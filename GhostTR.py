...
# API timeout in seconds - increased from default to avoid false failures on slow connections
API_TIMEOUT = 10
...
def IP_Track():
    ...
    req_api = requests.get(f"http://ipwho.is/{ip}", timeout=API_TIMEOUT)  # API IPWHOIS.IS
